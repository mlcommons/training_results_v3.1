...
def build_dataset(dataset_list, transforms, dataset_catalog, is_train=True, global_transforms=False, transforms_properties=None, max_num_polygons=0, mask_loss_from_global=False, comm=None, master_rank=0):
    """
    Arguments:
    ...
    for dataset_name in dataset_list:
        ...
        if data["factory"] == "COCODatasetPYT":
            ...
            args["max_num_polygons"] = max_num_polygons
            args["mask_loss_from_global"] = mask_loss_from_global
            args["comm"] = comm
...
def make_data_loader(
    ...
    _, _, _, _, max_num_polygons = cfg.DATALOADER.MASK_LOSS_FROM_GLOBAL_NUMELS
    ...
    datasets, epoch_size = build_dataset(dataset_list, None if is_hybrid_loader else transforms, DatasetCatalog, is_train, 
            cfg.DATALOADER.GLOBAL_TRANSFORMS, transforms_properties, max_num_polygons, cfg.DATALOADER.MASK_LOSS_FROM_GLOBAL_TENSORS,
            comm, master_rank)
