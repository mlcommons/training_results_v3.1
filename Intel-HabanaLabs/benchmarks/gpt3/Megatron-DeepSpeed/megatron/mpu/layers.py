...
class ColumnParallelLinear(torch.nn.Module):
    ...
    def __init__(self, input_size, output_size,
        ...
        self.output_parallel_linear = flatten_input(F.linear)
    ...
    def forward(self, input_):
        ...
        if self.training and self.output_parallel_linear_fp8 is not None:
            output_parallel = flatten_input(self.output_parallel_linear_fp8)(gather_input(input_parallel), self.weight, self.bias)
        else:
...
class RowParallelLinear(torch.nn.Module):
    ...
    def forward(self, input_):
        ...
        # Matrix multiply.
        if self.training and self.output_parallel_linear_fp8 is not None:
            output_parallel = flatten_input(self.output_parallel_linear_fp8)(input_parallel, self.weight)
        else:
