...
class DotGeneralRaw:
  ...
  contraction_axis_local_aqt_factor: Optional[int]
  ...
  def make(
    ...
    return DotGeneralRaw(
        ...
        contraction_axis_local_aqt_factor=local_aqt_factor,
    )
...
class DotGeneral:
  ...
  def make(
      ...
      dlhs_local_aqt_factor: Optional[int] = None,
      drhs_local_aqt_factor: Optional[int] = None,
  ) -> 'DotGeneral':
    """Create quantization configs for input matrices to a matmul."""
    fwd = DotGeneralRaw.make(lhs_bits, rhs_bits)
    dlhs = DotGeneralRaw.make(
        bwd_bits, bwd_bits, local_aqt_factor=dlhs_local_aqt_factor
    )
    drhs = DotGeneralRaw.make(
        bwd_bits, bwd_bits, local_aqt_factor=drhs_local_aqt_factor
    )
