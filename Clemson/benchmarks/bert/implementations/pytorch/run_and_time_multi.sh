...
#source /workspace/bert/config_1xR750xax2A100-80GB-PCIe.sh
source /workspace/bert/configs/packed_config_${SLURM_JOB_NUM_NODES}xR750xax2A100-80GB-PCIe.sh
...
PHASE2="\
    ...
    --init_checkpoint=/workspace/phase1/tf2_ckpt/model.ckpt-28252.pt \
    "
...
echo "${LOGGER} ${BERT_CMD} --seed=${SEED}"
