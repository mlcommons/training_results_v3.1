...
source $(dirname ${BASH_SOURCE[0]})/config_common_XE9640.sh
source $(dirname ${BASH_SOURCE[0]})/config_common_XE9640_benchmark.sh
...
source $(dirname ${BASH_SOURCE[0]})/config_common_XE9640_single_node.sh
