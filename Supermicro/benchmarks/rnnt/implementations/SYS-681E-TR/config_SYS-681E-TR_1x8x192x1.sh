...
export DATADIR="/data/share/rnnt/datasets/"
export METADATA_DIR="/data/share/rnnt/datasets/metadata/"
export SENTENCEPIECES_DIR="/data/share/rnnt/datasets/sentencepieces/"
