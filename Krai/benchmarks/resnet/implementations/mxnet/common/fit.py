...
def fit(args, kv, model, initializer, data_loader, devs, arg_params, aux_params, **kwargs):
    ...
    total_steps = get_epoch_size(args, kv) * args.num_epochs
    if args.optimizer in {'sgdwlars', 'sgdwfastlars','sgdwfastlarsv2'}:
        ...
        mx_resnet_print_event(key=constants.LARS_OPT_LR_DECAY_STEPS, val=total_steps)
        ...
        mx_resnet_print_event(key='sgd_opt_learning_rate_decay_steps', val=total_steps)
