...
_cont_mounts=("--volume=${DATADIR}:/data" "--volume=${LOGDIR}:/results" "--volume=${PKLPATH}:/pkl_coco" "--volume=${DATADIR}/coco_train2017_pyt:/coco_train2017_pyt" "--volume=${DATADIR}/coco_val2017_pyt:/coco_val2017_pyt")
